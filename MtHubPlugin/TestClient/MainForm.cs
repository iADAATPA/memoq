...
namespace MT_SDK
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            plugins.Add(PluginInfoFactory.Create(new MtHubPluginDirector()));
        ...
        private void populateLanguageSelectors()
        {
            ...
            var supportedLangs = new List<string>() { "eng-us", "fre-fr", "ger-de", "spa-es", "eng", "en", "fin", "fre", "fr", "ger", "hun", "ita", "por", "spa" };
        ...
        private bool checkSelectedLanguages()
        {
            ...
            if (!actPlugin.IsLanguagePairSupported((cbSourceLanguage.SelectedItem as Language).LangCode, (cbTargetLanguage.SelectedItem as Language).LangCode))
            {
                ...
                btnStoreTranslation.Enabled = true;
                tbTarget.ReadOnly = false;
        ...
        private void gbPluginDetails_Enter(object sender, EventArgs e)
        {
